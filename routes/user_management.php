    ...
    */
    ...
    function () {
        ...
        function () {
            ...
            route::get('/employee_list', 'UsersController@index_e')->name('index_e');
            ...
            Route::group(['prefix' => 'create', 'as' => 'create.'], function(){
                ...
                Route::get('/', 'UsersController@create')->name('default');
                Route::get('/employee', 'UsersController@create')->name('employee');
                Route::get('/customer', 'UsersController@create')->name('customer');
